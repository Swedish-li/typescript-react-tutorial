...
import { AddTodoAction, DeleteTodoAction, EditTodoAction, CompleteTodoAction, CompleteAllTodoAction, ClearCompletedTodoAction } from '../reducers/todos'
...
export const completeAllTodos = (): CompleteAllTodoAction => ({ type: types.COMPLETE_ALL_TODOS })
export const clearCompleted = (): ClearCompletedTodoAction => ({ type: types.CLEAR_COMPLETED })
